...
DefinitionBlock ("ssdt.aml", "SSDT", 1, "APPLE ", "CpuPm", 0x00021500)
{
    ...
    Scope (\_PR_.CPU0)
    {
        ...
        {
            Store ("ssdtPRGen version.....: 21.5 / Mac OS X 10.15.6 (19G46c)", Debug)
            Store ("custom mode...........: 0", Debug)
            Store ("host processor........: Intel(R) Core(TM) i7-6500U CPU @ 2.50GHz", Debug)
            Store ("target processor......: i7-6500U", Debug)
